...
var TOOLS = [
  ...
  { id:"securezip", name:"Secure ZIP", badge:"ENCRYPTED", code:"ZIP", accent:"magenta", wide:true,
    blurb:"Attach files or paste text and get them back as a single encrypted .zip, with a strong random password. Choose ZipCrypto, which Windows opens on its own, or AES-256 when the contents matter. Everything happens in your browser — nothing is uploaded.",
    sources:"ZipCrypto (PKWARE) · WinZip AE-2 · PBKDF2-HMAC-SHA1 · AES-256-CTR · HMAC-SHA1" },
